      ...
      <div className="ml-8 space-y-6">
        {[
          ...
          <div
            ...
            "
          >
            <h3 className={`text-xl font-bold text-${color}-500 dark:text-${color}-400 mb-3`}>
              {title}
            </h3>
            ...
            {title === 'Experiencia' && (
              <>
                <p className="font-semibold">Desarrolladora Full Stack (en progreso)</p>
                <p className="text-sm opacity-80">
                  Experiencia profesional: próximamente
                </p>
                <p className="mt-2">
                  Proyectos propios, trabajos académicos y muchas horas debuggeando 😅
                </p>
              </>
            )}
